  ...
  return (
    <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl overflow-x-auto no-scrollbar px-4">
      ...
      <div className="flex gap-4 pb-4">
        {/* Add a story */}
        <div className="flex-shrink-0 rounded-lg shadow-sm w-32 h-40 cursor-pointer hover:shadow-lg transition-all duration-300 border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white">
